var modal = document.getElementById("modal__item");
var openBtn = document.getElementById("open__modal");
var span = document.getElementsByClassName("close")[0];
openBtn.onclick = function () {
  modal.classList.add("active");
};

let audik = new Audio("./assets/mp.mp3");
...
function mysubmit(e) {
  ...
  name === "" || phone === ""
    ...
    :   fetch(
        `https://api.telegram.org/bot5264512834:AAFrGhtTrbK1dRgKw--CnNQbL7e2zAtePPs/sendMessage?chat_id=-1001642770774&text=${data}`
      ).then(() =>modal.classList.remove("active"), document.getElementById("error").style.display = "none");
